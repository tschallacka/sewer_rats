...
public class FollowFoodHolder extends EntityAIBase
{
    ...
    public FollowFoodHolder(EntityCreature temptedEntityIn, double speedIn, boolean scaredByPlayerMovementIn)
    {
    ...
    {
        return this.isEdibleItem(stack);
    }
